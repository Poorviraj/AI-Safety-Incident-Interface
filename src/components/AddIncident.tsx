...
const AddIncident: React.FC<Props> = ({ onAdd, incidents }) => {
    ...
    return <div>
        ...
        <div className=' bg-white flex mt-[20px] pt-[20px] pb-[20px] rounded-2xl w-[70%] mx-auto items-center  ' >
            <h1 className=' text-5xl ml-[10px] ' >AI Safety Incident Interface</h1>
            <button onClick={() => setShowForm(!showForm)} className=' bg-blue-500 text-white rounded-md px-4 mr-[10px] py-2 ml-auto ' >
        ...
        {
            showForm && (
                <form className=' w-[70%] bg-white pb-[20px] rounded-2xl mx-auto flex flex-col gap-5 items-center pt-[10px] ' onSubmit={handleSubmit} >
                    ...
                    <button type="submit" className=' w-[80%] h-[40px] bg-blue-500 text-white rounded-md ' >Add Incident</button>
                </form>
            )
